...
<body>
	...
	<div class="container-fluid">
		<h4 style="padding: 20px" class="bg-light text-center text-danger">Pending Orders</h4>
	</div>
	<br>
				...
				<div class="col-md-6 ud-card-p">
					...
					<form>
						...
						<div class="row uc-button">
							<div class="col-6">
								<button style="font-size: 16px" type="submit">Live</button>
							</div>
									
							<div class="col-6">
								<button style="font-size: 16px" type="submit">Remove</button>
							</div>
						</div>
					</form>
					</div>	
