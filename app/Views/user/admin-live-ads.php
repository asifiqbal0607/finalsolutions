...
<body>
	...
	<div class="container-fluid">
		<h4 style="padding: 20px" class="bg-light text-center text-danger">Live Ads</h4>
	</div>
	<br>
	...
	<div class="container">
		<div class="row">
			<div style="padding: 0px" class="col-md-3 ud-links bg-light">
				...
				<p style="margin-bottom: 0px"><a href="<?php echo base_url(); ?>/home/editpages">Edit Pages</a></p>
			...
			<div class="row">
				<div class="col-md-6 ud-card-p">
					...
					<form>
						...
						<div class="container">
						<div class="row uc-input">
								<span style="font-size: 15px; padding-bottom: 2px">Remaining Time</span>
								<input type="text" name="s-date"  />
						</div>
						</div>
						<div class="row uc-button">
							<div class="col-6">
								<button style="font-size: 16px" type="submit">Submit</button>
							</div>
									
							<div class="col-6">
								<button style="font-size: 16px" type="submit">Complete</button>
							</div>
						</div>
					</form>
					</div>	
