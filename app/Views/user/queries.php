...
<body>
	...
	<div class="container-fluid">
		<h4 style="padding: 20px" class="bg-light text-center text-danger">Queries</h4>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-3 ud-links">
				...
				<p style="margin-bottom: 0px" class="first-p"><a href="<?php echo base_url(); ?>/home/queries">Queries</a></p>
				...
				<table id="example" class="display" style="width:100%">
						...
						<tbody>
							<tr>
								...
								<td>10/11/2021</td>
								<td>20/11/2021</td>
								<td class="msgs">Lorem ipsum is a dummy text.Lorem ipsum is a dummy text.Lorem ipsum is a dummy text.
