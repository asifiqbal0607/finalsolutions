...
<div class="container-fluid">
    <img src="<?php echo base_url(); ?>/assets/images/b11.jpg" width="100%" alt="img"/>
</div>
<br/><br/>
<div class="container">
    <h4> WHO <span class="text-danger">WE ARE</span></h4>
    <p style="text-align: justify">There are many variations of passages of Lorem Ipsum available, but the majority have
...
<br/><br/>
<div class="container">
    <h4><span class="text-danger">OUR</span> VISION</h4>
    <p style="text-align: justify">There are many variations of passages of Lorem Ipsum available, but the majority have
        suffered alteration in some form, by injected humour, or randomised words which don't look even slightly
        believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything
        embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat
...
<br/><br/>
<div class="container">
    <h4> OUR <span class="text-danger">GOAL</span></h4>
    <p style="text-align: justify">There are many variations of passages of Lorem Ipsum available, but the majority have
        suffered alteration in some form, by injected humour, or randomised words which don't look even slightly
        believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything
        embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat
